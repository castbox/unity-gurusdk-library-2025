...
namespace Guru
{
	...
	public class AdjustService
	{
		...
		private void ProcessAdjustAttributionChanged(AdjustAttribution changedAttribution)
		{
			...
			ProcessAdjustAttributionChangedAsync(changedAttribution).Forget();
		}


		private async UniTaskVoid ProcessAdjustAttributionChangedAsync(AdjustAttribution changedAttribution)
		{
