...
namespace Guru
{
    ...
    public class AppsflyerConversionData
    {
        ...
        public string? GetAd()
        {
            ...
            try
            {
                return !_conversionData.TryGetValue("af_ad", out var ad) ? null : (string?)ad;
            }
            catch (Exception e)
            {
                Log.W($"[AppsFlyer] : Failed to get ad from conversion data: {e.Message}");
                return null;
            }
        }
        ...
        public object? GetValue(string key)
        {
            ...
            try
            {
                return _conversionData.GetValueOrDefault(key);
            }
            catch (Exception e)
            {
                Log.W($"[AppsFlyer] : Failed to get conversion data: {e.Message}");
                return null;
            }
        }
