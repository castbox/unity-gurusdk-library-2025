namespace Guru
{
    ...
    public partial class GuruSDK
    {
        ...
        /// 关闭 Debugger
        /// </summary>
        /// <param name="closeAll">关闭所有视图组件</param>
        public static void CloseDebugger(bool closeAll = false)
        {
            ...
            {
                Debugger.CloseAll();
                Debug.GuruDebugConsole.Instance.HideConsole();
            }
            else
            {
                Debugger.Close();
        ...
        private static void InitBaseOptionLayout()
        {
            ...
            Debugger.AddOption("Info/Close Debugger", "", () => CloseDebugger(true));
