namespace Guru.Ads.Max
{
    ...
    public class MaxInterstitialLoader
    {
        ...
        private void SendAdImpEvent(string adUnitId, MaxSdkBase.AdInfo adInfo)
        {
            ...
            var e = MaxAdEventBundleFactory.BuildIadsImp(adUnitId, adInfo, _adPlacement, reviewCreativeId);
        ...
        private void OnAdClickedEvent(string adUnitId, MaxSdkBase.AdInfo adInfo)
        {
            var reviewCreativeId = _reviewCreativeIdCache.GetReviewedCreativeId(adInfo);
            // 广告点击
            var e = MaxAdEventBundleFactory.BuildIadsClick(adUnitId, adInfo, _adPlacement, reviewCreativeId);
        ...
        private void OnAdPaidEvent(string adUnitId, MaxSdkBase.AdInfo adInfo)
        {
            var reviewCreativeId = _reviewCreativeIdCache.GetReviewedCreativeId(adInfo);
            // 广告收益
            var e = MaxAdEventBundleFactory.BuildIadsPaid(adUnitId, adInfo, _adPlacement, reviewCreativeId);
