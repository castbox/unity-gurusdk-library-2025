...
public class CDNLoader : MonoBehaviour
{
    ...
    private ICdnLoaderDataProvider _dataProvider;
    private static ICdnLoaderDataProvider _globalDataProvider;
    ...
    /// <returns></returns>
    public static CDNLoader Create(ICdnLoaderDataProvider provider)
    {
        if (provider == null)
            provider = _globalDataProvider;
        
        if (provider == null)
            throw new Exception($"RemoteData Provider is missing {nameof(ICdnLoaderDataProvider)}.");
    ...
    /// </summary>
    /// <param name="provider"></param>
    public static void SetGlobalDataProvider(ICdnLoaderDataProvider provider)
    ...
    /// 设置默认值
    /// </summary>
    /// <param name="provider">配置默认值</param>
    private void SetDataProvider(ICdnLoaderDataProvider provider)
    {
        _dataProvider = provider;
        _defaultConfig = _dataProvider.GetDefaultConfig();
        _onlineConfig = _dataProvider.GetOnlineConfig();
    }
...
/// RemoteData Provider
/// </summary>
public interface ICdnLoaderDataProvider
{
    // 获取默认配置
    CDNConfig GetDefaultConfig();
    
    // 获取线上配置
    CDNConfig GetOnlineConfig();
}
