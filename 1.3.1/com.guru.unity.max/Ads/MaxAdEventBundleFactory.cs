namespace Guru.Ads.Max
{
    ...
    public static class MaxAdEventBundleFactory
    {
        ...
        public static BadsPaidEvent BuildBadsPaid(string adUnitId, MaxSdkBase.AdInfo adInfo, string placement)
        {
        ...
        public static IadsImpEvent BuildIadsImp(string adUnitId, MaxSdk.AdInfo adInfo, string placement)
        {
        ...
        public static IadsClickEvent BuildIadsClick(string adUnitId, MaxSdk.AdInfo adInfo, string placement)
        {
        ...
        public static IadsPaidEvent BuildIadsPaid(string adUnitId, MaxSdkBase.AdInfo adInfo, string placement)
        {
        ...
        public static RadsImpEvent BuildRadsImp(string adUnitId, MaxSdk.AdInfo adInfo, string placement)
        {
        ...
        public static RadsClickEvent BuildRadsClick(string adUnitId, MaxSdkBase.AdInfo adInfo, string placement)
        {
        ...
        public static RadsPaidEvent BuildRadsPaid(string adUnitId, MaxSdkBase.AdInfo adInfo, string placement)
        {
        ...
        public static RadsRewardedEvent BuildRadsRewarded(string adUnitId, MaxSdkBase.AdInfo adInfo, string placement)
        {
