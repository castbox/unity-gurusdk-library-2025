...
namespace I2.Loc
{
    ...
    {
        static string[] LanguagesRTL =
        {
            "ar-DZ", "ar", "ar-BH", "ar-EG", "ar-IQ", "ar-JO", "ar-KW", "ar-LB", "ar-LY", "ar-MA", "ar-OM", "ar-QA",
            "ar-SA", "ar-SY", "ar-TN", "ar-AE", "ar-YE",
            "fa", "he", "ur", "ji"
        };
        ...
        public static string ApplyRTLfix(string line, int maxCharacters, bool ignoreNumbers)
        {
            ...
            for (int i = 0; i < tags.Count; i++)
            {
                ...
                for (int j = 0; j < len; ++j)
                {
                    if (line[j] == '@' && line[j + 1] == '@' && line[j + 2] >= tagBase && line[j + 3] == '@' &&
                        line[j + 4] == '@')
                    {
