    ...
    */
    ...
    public class IadsImpEvent : AbstractAdImpEvent
    {
        public IadsImpEvent(
            ...
            string placement,
            string adPlatform) 
            : base(AdEvent.IADS_IMP, adUnitId, adSource, adPlacement, adCreativeId, placement, adPlatform)
        {
        }
    }
    ...
    public class IadsClickEvent : AbstractAdDetailEvent
    {
        public IadsClickEvent(
            ...
            string placement,
            string adPlatform) 
            : base(AdEvent.IADS_CLK, adUnitId, currency, value, adSource, adPlacement,adCreativeId, placement, adPlatform)
        {
        }
    }
    ...
    public class IadsPaidEvent : AbstractAdPaidEvent
    {
        public IadsPaidEvent(
            ...
            string placement,
            string adPlatform) :
            base(AdEvent.IADS_PAID, adUnitId, currency, value, adSource, adPlacement, adCreativeId, adFormat, placement, adPlatform)
        {
    ...
    public class RadsImpEvent : AbstractAdImpEvent
    {
        public RadsImpEvent(
            ...
            string placement,
            string adPlatform) 
            : base(AdEvent.RADS_IMP, adUnitId, adSource, adPlacement, adCreativeId, placement, adPlatform)
        {
        }
    }
    ...
    public class RadsPaidEvent : AbstractAdPaidEvent
    {
        public RadsPaidEvent(
            ...
            string placement,
            string adPlatform) :
            base(AdEvent.RADS_PAID, adUnitId, currency, value, adSource, adPlacement, adCreativeId, adFormat, placement, adPlatform)
        {
