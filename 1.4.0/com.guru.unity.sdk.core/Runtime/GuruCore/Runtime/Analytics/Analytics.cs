namespace Guru
{
	...
	public partial class Analytics
	{
		...
		public static void TrackEvent(ITrackingEvent trackingEvent)
		{
			...
			{
				SafetyLogEvent(_firebaseEventDriver, trackingEvent);
			}
		...
		/// <summary>
		/// 安全上报打点事件， 分开 Catch 异常
		/// </summary>
		/// <param name="driver"></param>
		/// <param name="evt"></param>
		private static void SafetyLogEvent<T>(T driver, ITrackingEvent evt) where T : AbstractEventDriver
		{
			try
			{
				// 填充相关的追踪事件
