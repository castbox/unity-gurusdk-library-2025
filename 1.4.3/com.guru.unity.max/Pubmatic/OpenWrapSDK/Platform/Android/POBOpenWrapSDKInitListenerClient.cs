...
namespace OpenWrapSDK.Android
{
    ...
    /// </summary>
    public class POBOpenWrapSDKInitListenerClient : AndroidJavaProxy, IPOBOpenWrapSDKInitListenerClient
    {
        ...
        internal POBOpenWrapSDKInitListenerClient() : base(POBConstants.OpenWrapSDKInitListenerClass) {
        ...
        public void onFailure(AndroidJavaObject error)
        {
            ...
            {
                POBEventsDispatcher.ScheduleInUpdate(() => {
                    OnFailure(this, POBAndroidUtils.ConvertToPOBErrorEventArgs(error));
                });
