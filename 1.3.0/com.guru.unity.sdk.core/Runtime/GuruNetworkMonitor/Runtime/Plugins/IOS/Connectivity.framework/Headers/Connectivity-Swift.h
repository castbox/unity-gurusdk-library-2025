...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull CONNECTIVITY_TETHER;)
+ (NSString * _Nonnull)CONNECTIVITY_TETHER SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)initialize SWIFT_WARN_UNUSED_RESULT;
- (void)startupMonitorWithCompletion:(void (^ _Nonnull)(BOOL))completion;
- (void)registerNetConnectivityChangingListener:(void (^ _Nonnull)(NSString * _Nonnull))listener;
- (void)registerNetConnectivityChangingBroadcastReceiverWithGameObjectReceiverName:(NSString * _Nonnull)gameObjectReceiverName broadcastMethodName:(NSString * _Nonnull)broadcastMethodName;
- (void)unRegisterNetConnectivityChangingListener;
- (void)unRegisterNetConnectivityChangingBroadcastReceiver;
- (NSArray<NSString *> * _Nonnull)checkNetConnectivity SWIFT_WARN_UNUSED_RESULT;
- (void)shutdownMonitor;
- (void)unInitialize;
@end


SWIFT_CLASS("_TtCC12Connectivity12Connectivity18UnityMessageSender")
@interface UnityMessageSender : NSObject
+ (void)sendMessage:(NSString * _Nullable)gameObject method:(NSString * _Nullable)method message:(NSString * _Nonnull)message;
